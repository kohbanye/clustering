...
class KMeansPP(Clustering):
    ...
    def fit(self, X: np.ndarray):
        ...
        for _ in range(self.k - 1):
            ...
            self.first_centroids = np.append(self.centroids, X[new_centroid_index, :], axis=0)
...
if __name__ == "__main__":
    ...
    ax[0][0].scatter(kmeans.first_centroids[:, 0], kmeans.first_centroids[:, 1], c="black")
    ...
    ax[0][1].scatter(kmeans_pp.first_centroids[:, 0], kmeans_pp.first_centroids[:, 1], c="black")
